...
SKIN.colTextEntryText			= Color( 100, 100, 100, 255 )
...
SKIN.Colours.Window = {}
SKIN.Colours.Window.TitleActive			= GWEN.TextureColor( 4 , 508 )
SKIN.Colours.Window.TitleInactive		= GWEN.TextureColor( 4 + 8, 508 )
...
derma.DefineSkin( "JC2MP", "From Just Cause 2 Multiplayer", SKIN )
